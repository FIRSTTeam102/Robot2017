...
import org.usfirst.frc.team102.robot.MotorAmperageHelper;
...
public class DriveTrain extends /*PID*/Subsystem implements CommandUpdate.IUpdate {
	...
	public DriveTrain() {
		...
		drive = new RobotDrive(frontLeftTal = new CANTalon(RobotMap.t0CANTalon), rearLeftTal = new CANTalon(RobotMap.t1CANTalon),
				frontRightTal = new CANTalon(RobotMap.t7CANTalon), rearRightTal = new CANTalon(RobotMap.t8CANTalon));
	...
	public int getEncoderTicksRaw() { return frontRightTal.getEncPosition(); }
	public int getEncoderTicks() { return getEncoderTicksRaw() - encoderZeroPos; }
	public void resetEncoder() { encoderZeroPos = getEncoderTicksRaw(); }
	public double getEncoderDistance() { return Math.abs((double)getEncoderTicks()) / RobotMap.ENCODER_TICKS_PER_INCH; }
	public boolean hasDriven(double dist) { return getEncoderDistance() >= dist; }*/
}